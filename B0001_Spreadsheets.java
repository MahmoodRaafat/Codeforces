...
marked by AZ. After ZZ there follow three-letter numbers, etc.
The rows are marked by integer numbers starting with 1. The cell name is the concatenation of 
the column and the row numbers. For example, BC23 is the name for the cell that is in column 
55, row 23.
...
public class B0001_Spreadsheets {
	...
	public static void main(String[] args) {
		...
		for (int i=0; i<n; i++) {
			...
			// for each input, determine which numeration system it is (either RXCY or CR)
			boolean rxcy = false;
