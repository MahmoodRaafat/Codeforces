...
becomes empty. No passenger will enter the train at the last stop. That is, bn = 0. 
...
public class A116_Tram {
	public static void main(String[] args) {
		...
		//calculate # of people on tram after every stop, print highest value
		for (int i=0; i<stops; i++) {
			int off = sc.nextInt(), on = sc.nextInt();
			compare = compare - off + on;
			res = Math.max(res, compare);
		}
