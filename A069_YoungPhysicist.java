...
complete his physics tasks. Next day the teacher got very angry at Vasya and decided 
...
by the given vectors of forces.

Input
The first line contains a positive integer n (1 <= n <= 100), then follow n lines 
containing three integers each: the xi coordinate, the yi coordinate and the zi 
coordinate of the force vector, applied to the body (-100 <= xi, yi, zi <= 100).
...
public class A069_YoungPhysicist {
	public static void main(String[] args) {
		...
		// each line gives components of vectors (x component, y component, z component).
		// vector components in the same direction can be added together
		...
		// body is in equillibrium if all the components are 0
