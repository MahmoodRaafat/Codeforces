...
import java.util.*;
public class A1102_IntegerSequenceDividing {
...
/*
 * find the result of the minimum difference of sets of every number from 1-50 
 * (with the code below) and you will see a pattern: 1, 1, 0, 0, 1, 1, 0, 0, ... 
 * that repeats every 4 numbers
